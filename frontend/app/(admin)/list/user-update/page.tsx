            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4"> 
              ...
              <div className="mt-4">
                  ...
                  <label className="flex items-center">
                        <input type="radio" id="male" name="gender" value="M" checked={userData.gender === "M"} onChange={(e) => setUserData({ ...userData, gender: e.target.value })} className="form-radio text-black"/>
                        <span className="ml-2 text-black">Male</span>
                        </label>

                        <label className="flex">
                        <input type="radio" id="female" name="gender" value="F" checked={userData.gender === "F"} onChange={(e) => setUserData({ ...userData, gender: e.target.value })} className="form-radio text-black"/>
              ...
              <div className="space-y-2">
                <Dropdown>
                  ...
                  <DropdownMenu aria-label="Role Selection">
                    {roles.map((role) => (<DropdownItem key={role} onClick={() => handleRoleChange(role)}>
                        {role}
                      </DropdownItem>))}
                  </DropdownMenu>
                </Dropdown>
          ...
          <div className="p-4 bg-blue-100 rounded">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <Dropdown>
                    ...
                    {statusOptions.map((status) => (<DropdownItem key={status} onClick={() => handleStatusChange(status)}>
                        {status}
                        </DropdownItem>))}
                    </DropdownMenu>
                </Dropdown>
            ...
            <div className="p-4 bg-blue-100 rounded">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {addresses.map((address) => (<div key={address.address_id} className="relative p-4 bg-white rounded shadow">
                  ...
                  <ModalBody>
                    <form className="space-y-4 my-8">
                      ...
                      <div className="flex justify-center">
                        <Button className="w-52 h-10 bg-black text-white rounded-none text-lg" onClick={() => addAddress(userData.userId)}>
                          Save
                        </Button>
                      </div>
                    </form>
