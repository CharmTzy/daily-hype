...
export default function Page() {
    ...
    const handleFacebookLoginStatus = (response: {
        status: string;
    }) => {
        ...
        window.FB.login(function (response: FacebookAuthResponse) {
            if (response.authResponse) {
                ...
                window.FB.api("/me", { fields: "id,name,email,picture" }, function (fbUser: FacebookUser) {
                    ...
                    console.log("Facebook User Information:", fbUser);
                    fetch(`${process.env.BACKEND_URL}/api/signupFacebook`, {
                        ...
                        body: JSON.stringify({
                            ...
                            res_picture: picture ? picture.data.url : null,
                        }),
                        credentials: "include",
                    })
                        .then((response) => {
    ...
    return (<>
      ...
      <div className="w-full min-h-screen grid grid-cols-1 sm:grid-cols-2">
        {!showAdditional && (<div className="left w-full min-h-screen flex flex-col justify-center items-center gap-10 bg-[#FB6050] text-white" id="initialFields">
        ...
        {showAdditional && (<div className="left w-full min-h-screen flex justify-center  gap-10 bg-[#FB6050] text-white" id="additionalFields">
            <div className="additional w-full flex flex-col justify-center items-center mt-25vh gap-10">
              ...
              <div className="w-full">
                ...
                <div className="w-full flex flex-col items-center sm:flex-row sm:justify-center">
                  <button className="bg-white text-black px-6 py-3 uppercase rounded-md hover:bg-gray-200 mb-2 sm:mb-0 sm:mr-4 md:mr-8 lg:mr-12 xl:mr-16 2xl:mr-48" onClick={() => {
                handleVerification();
                onOpenChange();
        ...
        {showVerificationModal && (<Modal isOpen={isOpen} onOpenChange={onOpenChange}>
            <ModalContent>
              {(onClose) => (<>
        ...
        <div className="right w-full h-screen flex flex-col justify-center items-center bg-[#0c0f38] text-white">
          <a href={URL.Home} className="logo-box">
            <BrandLogo size="lg" theme="light" tagline="Modern fits for every mood"/>
          </a>
