...
export default function CarouselItem({ data, currentActiveNo }: CarouselItemProps) {
    ...
    return (
        <section className="mx-auto w-full max-w-7xl px-4 pt-5 sm:px-6 lg:px-8 lg:pt-8">
            <div className="grid overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_24px_80px_-48px_rgba(15,23,42,0.45)] lg:grid-cols-[1fr_0.9fr]">
                <div className="order-2 flex flex-col justify-center px-5 py-6 sm:px-8 sm:py-8 lg:order-1 lg:px-10 lg:py-12">
                    ...
                    <h1 className="mt-5 max-w-xl text-3xl font-semibold tracking-tight text-slate-950 sm:text-4xl lg:text-[2.8rem]">
                        {productName}
                    </h1>
                ...
                <div className="order-1 border-b border-slate-200 bg-slate-100 lg:order-2 lg:border-b-0 lg:border-l">
