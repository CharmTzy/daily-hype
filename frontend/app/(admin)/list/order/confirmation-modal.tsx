...
export default function OrderConfirmationModal({ setRefresh, selectedOrder, setSelectedOrder, isOpen, onClose, processLoading, setProcessLoading, action }: IOrderConfirmationModalProps) {
    ...
    return (<Modal size="3xl" isOpen={isOpen} onClose={onClose} scrollBehavior="inside">
      <ModalContent>
        {(onClose) => (<>
            ...
            <ModalBody>
              ...
              <div className="flex w-full">
                ...
                return (<div key={index} className="flex max-w-full w-full mt-2">
            ...
            <ModalFooter>
              ...
              <Button color={action === "Confirm" ? "primary" : "danger"} disabled={processLoading} onClick={() => {
