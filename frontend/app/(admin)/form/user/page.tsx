...
import { Button, RadioGroup, Radio, Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, Input, image, } from "@nextui-org/react";
      ...
      <div className="mx-auto max-w-[350px] space-y-6">
        ...
        <div>
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Input label="Confirm Password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required type="password"/>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Button className="bg-black text-white" type="submit" onClick={() => handleSignUp(file)}>
                Sign Up
              </Button>
