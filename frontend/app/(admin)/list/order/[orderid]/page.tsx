      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-5 space-y-4">
            ...
            {items.map((item, index) => (<div key={`${item.productdetailid}-${index}`} className="grid gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 md:grid-cols-[100px,1fr,160px]">
