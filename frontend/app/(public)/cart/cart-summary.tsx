...
export default function CartSummary({ toShow, subTotal, theme, disabled, isAuthenticated }: ICartSummaryProps) {
    ...
    return (<>
      {toShow && (<>
          ...
          <Button color="secondary" className="laptop-2xl:w-[150px] laptop-2xl:h-12 laptop-2xl:text-[16px] disabled:opacity-50 rounded-md ms-auto mr-16 mt-4 disabled:cursor-not-allowed mb-4" disabled={disabled} onClick={() => {
                if (isAuthenticated) {
