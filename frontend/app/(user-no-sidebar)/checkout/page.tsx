...
export default function Page() {
    ...
    return (<div className="flex px-32 my-8 w-full justify-between">
      <div className="flex flex-col w-[650px]">
        <div className="flex items-center">
          ...
          {selectedAddress !== -1 && (<label className="ms-12 text-blue-500 cursor-pointer" onClick={onOpen}>
              Edit
            </label>)}
        </div>
        {selectedAddress === -1 && (<label className="mt-3">
      ...
      <div className="flex flex-col w-[450px]">
        ...
        <StripeCheckout orderID={orderID} clientSecret={clientSecret} isLoading={isLoading} totalAmount={totalAmount} onClick={() => {
            setIsLoading(true);
