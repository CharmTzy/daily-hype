...
export default function Profile() {
    ...
    return (<div className="container mx-auto mb-8 p-4">
      <div className="flex">
        ...
        <div className="w-3/4 p-4">
          ...
          <form className="form">
            ...
            {isModalOpen && (<div className="fixed z-10 inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50">
